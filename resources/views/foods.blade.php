...
@section('container')
  ...
  <div class="card-body text-center">
    ...
    <p>Kategori : <a href="/foods?category={{ $foods[0]->category->slug }}"class="text-decoration-none">{{ $foods[0]->category->name }}</a></p>
...
<div class="container">
    ...
    @foreach ($foods->skip(1) as $food)
        <div class="col-md-4 mb-3">
            ...
            <p>Kategori : <a href="/foods?category={{ $food->category->slug }}"class="text-decoration-none">{{ $food->category->name }}</a></p>
